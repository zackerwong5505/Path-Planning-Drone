...
if("TRUE" STREQUAL "TRUE")
  set(cvg_sim_gazebo_SOURCE_PREFIX /home/zack/test_ws/src/hypharos_ardrone_navigation/third_parties/tum-simulator-indigo/cvg_sim_gazebo)
  set(cvg_sim_gazebo_DEVEL_PREFIX /home/zack/test_ws/devel)
  ...
  set(cvg_sim_gazebo_INSTALL_PREFIX /home/zack/test_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'cvg_sim_gazebo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'elliot <elliot@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'cvg_sim_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zack/test_ws/src/hypharos_ardrone_navigation/third_parties/tum-simulator-indigo/cvg_sim_gazebo/${idir}'.  Ask the maintainer 'elliot <elliot@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${cvg_sim_gazebo_dep}_FOUND)
      find_package(${cvg_sim_gazebo_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cvg_sim_gazebo_dep} REQUIRED ${depend_list})
  endif()
