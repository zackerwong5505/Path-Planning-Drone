// Generated by gencpp from file cvg_sim_msgs/VelocityZCommand.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::cvg_sim_msgs::VelocityZCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cvg_sim_msgs::VelocityZCommand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cvg_sim_msgs::VelocityZCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cvg_sim_msgs::VelocityZCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cvg_sim_msgs::VelocityZCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cvg_sim_msgs::VelocityZCommand_<ContainerAllocator> const>
  : TrueType
  { };
