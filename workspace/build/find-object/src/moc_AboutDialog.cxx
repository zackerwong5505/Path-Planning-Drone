...
static const char qt_meta_stringdata_find_object__AboutDialog[] = {
    "find_object::AboutDialog\0"
};
...
const QMetaObjectExtraData find_object::AboutDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject find_object::AboutDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_find_object__AboutDialog,
      qt_meta_data_find_object__AboutDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &find_object::AboutDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_find_object__AboutDialog))
