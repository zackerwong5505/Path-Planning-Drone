...
#include "../../../../src/find-object/src/rtabmap/PdfPlot.h"
...
static const char qt_meta_stringdata_rtabmap__PdfPlotCurve[] = {
    "rtabmap::PdfPlotCurve\0"
};
...
const QMetaObjectExtraData rtabmap::PdfPlotCurve::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rtabmap::PdfPlotCurve::staticMetaObject = {
    { &UPlotCurve::staticMetaObject, qt_meta_stringdata_rtabmap__PdfPlotCurve,
      qt_meta_data_rtabmap__PdfPlotCurve, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rtabmap::PdfPlotCurve::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rtabmap__PdfPlotCurve))
        return static_cast<void*>(const_cast< PdfPlotCurve*>(this));
